...
var Utils = exports.Utils = {
  ...
  getAdblockStatus: function(page) {
    var isWhitelisted = require("whitelisting").isWhitelisted(page.url);
    var isWhitelistable = !!require("adblockcash").AdblockCash.isDomainWhitelistable( extractHostFromURL(page.url) );

    switch(true) {
      case (isWhitelisted && isWhitelistable):
        return "whitelisted";
      case (!isWhitelisted && isWhitelistable):
