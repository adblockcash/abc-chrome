...
let getStats = exports.getStats = function getStats(key, page)
{
  ...
  return pageStats ? pageStats[key] : 0;
};
...
FilterNotifier.addListener(function(action, item, newValue, oldValue, page)
{
  ...
  if (blocked)
  {
    ...
    Prefs.stats_by_domain[page.domain].blocked = Prefs.stats_by_domain[page.domain].blocked || 0;
    Prefs.stats_by_domain[page.domain].blocked++;
