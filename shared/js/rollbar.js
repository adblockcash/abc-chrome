// This is the copy of rollbar 1.1.14,
// but without the unnecessary JSON shim.
...
var Util = {
  ...
  copy: function(obj) {
    ...
    if (typeof obj === 'object') {
      // START ADBLOCKCASH CHANGE:
      // This doesn't work, propably because Object is in different window's context
      // if (obj.constructor == Object) {
      //   dest = {};
      // } else if (obj.constructor == Array) {
      //   dest = [];
      // }
      if (obj.constructor.toString().indexOf("Object") == 9) {
        dest = {};
      } else if (obj.constructor.toString().indexOf("Array") == 9) {
        dest = [];
      }
      // END ADBLOCKCASH CHANGE
    }
